...
$issue = new IssueBackup();
$issue = $this->issue_backup;
...
<div class="row">
    <div class="panel-wrapper">
        <div class="panel">
            ...
            <div class="content">  
                <!-- ## / Panel Content  -->
                <form class="form-horizontal" name="form" method="post" action="<?php echo link_to('issue/editHistory'); ?>" id ="edit-user-form" enctype="multipart/form-data" >
                    <!--       one Column        -->
                    <div>
                    ...
                    <div class="form-actions">
                        <input type="hidden" name="issue_backup_id" value="<?php echo $issue->getId(); ?>"/>
                        <a href="javascript:document.form.submit();" class="button-blue"><img src="<?php echo href_to('/templates/quickadmin/_layout/images/icons/ok.png'); ?>" style="padding-bottom: 1px;" />&nbsp; <?php  echo 'Save changes'; ?></a>
                        <a href="<?php echo $_SERVER['HTTP_REFERER'];?>" class="button-white"><img src="<?php echo href_to('/templates/quickadmin/_layout/images/icons/cancel.png'); ?>" style="padding-bottom: 1px;" />&nbsp; Cancel</a>
                    </div>
                </form>
            </div>
            <!--## / Panel Content  -->
