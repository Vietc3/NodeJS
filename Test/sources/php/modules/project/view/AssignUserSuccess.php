...
$project = new Project();
$project = ProjectPeer::RetrieveById($_GET['project_id']);
?>
<style>
        ...
        <div class="content">
            <form class="form-horizontal" method="post" action="<?php echo link_to('role/assignfunction'); ?>" id ="edit-user-form" enctype="multipart/form-data" >
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" class="input-xlarge" id="name" name="name" disabled="true" value="<?php echo $project->getName() ?>" placeholder="Name">
                    </div>
                </div>
                <div class="control-group">
                ...
                <div class="form-actions">
                    ...
                    <a href="javascript: history.go(-1)"><input style="width:150px;" type="button" class="button-white" value="<?php _e('Cancel'); ?>"/></a>
                </div>
            </form> 
            <!-- ## / Panel Content  -->
        </div>
