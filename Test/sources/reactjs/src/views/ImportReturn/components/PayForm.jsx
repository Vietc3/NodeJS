    ...
    if(visiblePayForm && !this.state.payAmount){
      ...
      if(this.paymentFormRef.ohFormRef.allValid()){
        ...
        let dataIncome = {
          ...
          customerId: dataPayment.customerId.id,
          incomeExpenseCardTypeId: Constants.DEFAULT_INCOME_EXPENSE_CARD_TYPES.IMPORT_RETURN,
          paymentDetail: [{
        ...
        let createdExpense = await IncomeExpenseService.saveIncomeCard(dataIncome);
        ...
        {visiblePayForm ? (
          ...
          >
            <PaymentForm
              ...
              customerId={dataPayment.customerId ? dataPayment.customerId.id : null}
